                        ...
                        <div class="col-md-4">
                            <form action="{{ url('program') }} " method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nameIn" value="{{ old('nameIn')}}" class="form-control @error('nameIn') is-invalid @enderror" autofocus>
                                    @error('nameIn')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="priceIn" value="{{ old('priceIn')}}" class="form-control @error('priceIn') is-invalid @enderror">
                                    @error('priceIn')
                                        <div class="invalid-feedback">{{ $message}} </div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="maksIn" class="form-control @error('maksIn') is-invalid @enderror">
                                    @error('maksIn')
                                        <div class="invalid-feedback">{{ $message}} </div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <label>Info</label>
                                    <textarea type="text" name="infoIn" class="form-control @error('infoIn') is-invalid @enderror" >
                                        {{ old('infoIn')}}
                                    </textarea>
                                    @error('infoIn')
                                    <div class="invalid-feedback">{{ $message}} </div>
