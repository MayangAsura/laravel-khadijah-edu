...
<head>
    ...
    <title>@yield('title') - KhadijahDev</title>
...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">MyKha</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{url('pengajar')}} "> <i class="menu-icon fa fa-puzzle-piece"></i>Pengajar </a>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        {{-- YIELD ==> Menampilkan , selaras dengan PHP ECHO KAYAKNYA 
            harus disertai SECTION (isi)
            --}}
        @yield('breadcrumbs')
